var works = [
    {'id':'work1','title':'パケットモニタリングシステム','description':'パケット量を表示し可視化するシステム。','technology':'Ruby、Ruby on Rails、JavaScript、Highcharts',
    'images':['imgs/portfolio/packetmonitoring1.png','imgs/portfolio/packetmonitoring2.png','imgs/portfolio/packetmonitoring3.png'],'url':''}, 
    ...
    'technology':'Ruby、Trema version 0.4.6','images':['imgs/portfolio/personalNapt.png'],'url':''},
];